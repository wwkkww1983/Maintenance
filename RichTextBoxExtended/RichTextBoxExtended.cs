    ...
    public partial class RichTextBoxExtended : UserControl
    {
            ...
            switch (e.Button.Tag.ToString().ToLower())
            {
                ...
                case"fontsize":
                    foreach (MenuItem mi in cmfontsize.MenuItems)
                    {
                        ...
                        if (mi.Checked == true)
                        {
                            ChangeFontSize(float.Parse(mi.Text));
                            break;
                        }
                    }
                    break;
                case"color":
                    ...
                    foreach (MenuItem mi in cmcolor.MenuItems)
                    {
                        ...
                        if (mi.Checked == true)
                        {
                            ChangeFontColor(Color.FromName(mi.Text));
                            break;
                        }
                    }
                    break;
        ...
        ************************************************************************************/
        ...
        public void ChangeFont(String str)
        {
            ...
            if (len <= 1 && rtb1.SelectionFont != null)
            {
                rtb1.SelectionFont = new Font(str, rtb1.SelectionFont.Size, rtb1.SelectionFont.Style);
            ...
            for (int i = 0; i < len; ++i)
            {
                ...
                rtbTemp.SelectionFont = new Font(str, rtbTemp.SelectionFont.Size, rtbTemp.SelectionFont.Style);
            }
