...
namespace FaTestSoft
{
    ...
    {
        public ControlDocmentView(ToolStripMenuItem ControlMenuItem)
        {
            InitializeComponent();
            this.ControlMenuItem = ControlMenuItem;

        }
        ToolStripMenuItem ControlMenuItem;
        ...
        private void ControlDocmentView_DockStateChanged(object sender, EventArgs e)
        {
            if (this.Visible == false)
                ControlMenuItem.Checked = false;
            else
