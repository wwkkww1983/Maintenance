...
namespace FaTestSoft
{
    ...
    {
        public RelayProtectForm(ToolStripMenuItem 继保定值视图ToolStripMenuItem)
        {
            InitializeComponent();
            this.继保定值视图ToolStripMenuItem = 继保定值视图ToolStripMenuItem;
        }
        ToolStripMenuItem 继保定值视图ToolStripMenuItem;
     ...
     if (num == 0)
       ...
       int value = 0;
        ...
        private void RelayProtectForm_DockStateChanged(object sender, EventArgs e)
        {
            if (this.Visible == false)
                继保定值视图ToolStripMenuItem.Checked = false;
            else
