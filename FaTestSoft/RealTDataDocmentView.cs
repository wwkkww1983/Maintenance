...
namespace FaTestSoft
{
    ...
    {
        public RealTDataDocmentView(ToolStripMenuItem MoniterMenuItem)
        {
            InitializeComponent();
            this.MoniterMenuItem=MoniterMenuItem;
        }

        //DataMoniterViewForm DataMviewfm = new DataMoniterViewForm();
        ToolStripMenuItem MoniterMenuItem;
        private int num = 0;
        static byte dex = 0;
        byte po = 0;
        ...
        private void RealTDataDocmentView_DockStateChanged(object sender, EventArgs e)
        {

            if (this.Visible == true)
                MoniterMenuItem.Checked = true;
            else
                MoniterMenuItem.Checked = false;
        }
