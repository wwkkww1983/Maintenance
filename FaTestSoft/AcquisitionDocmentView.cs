...
namespace FaTestSoft
{
    ...
    {
        Timer openCloseAutoCalltimer;
        Timer autoCalltimer;
        public AcquisitionDocmentView(ToolStripMenuItem ThreeYPMenuItem,Timer openCloseAutoCalltimer,Timer autoCalltimer)
        {
            InitializeComponent();
            this.ThreeYPMenuItem = ThreeYPMenuItem;
            this.openCloseAutoCalltimer = openCloseAutoCalltimer;
            this.autoCalltimer = autoCalltimer;
        }
        ToolStripMenuItem ThreeYPMenuItem;
       ...
       * ******************************************************************************************/
        ...
        private void downloadbutton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if(autoCalltimer.Enabled==true)
                {
                    autoCalltimer.Enabled = false;         
                    openCloseAutoCalltimer.Enabled = true;
                }
        ...
        private void AcquisitionDocmentView_DockStateChanged(object sender, EventArgs e)
        {
            if (this.Visible == false)
                ThreeYPMenuItem.Checked = false;
            else
