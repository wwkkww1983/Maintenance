...
{
    public delegate void UnCkeckIconHandler(string str);
    ...
    public partial class Form1 : Form
    {
        ...
        private RealTDataDocmentView m_realtdataview;
        //private SysPDocmentView m_syspview               = new SysPDocmentView();
        private CallDataDocmentView m_calldview;    
        CreateNewPrjForm NewPrjform                      = new CreateNewPrjForm();           //构造一个新的对象
        private HistoryDataDocmemtView m_historydataview;
        private AcquisitionDocmentView m_acquisitionview;
        private XMLCfg m_xmlcfgview;
        private ControlDocmentView m_controlview;
        private OtherTypeDocmentView m_otherview;
        ...
        private RelayProtectForm m_RPview;//继保定值视图
        private AutoCall autocall;
...
//usb
        ...
        public Form1()
        {
           ...
           test.SetDeviceNotify(0, iDeviceID, myCallBack);
            m_realtdataview = new RealTDataDocmentView(MoniterMenuItem);
            m_calldview = new CallDataDocmentView(CallMenuItem);
            m_historydataview = new HistoryDataDocmemtView(HisdataMenuItem);
            m_acquisitionview = new AcquisitionDocmentView(ThreeYPMenuItem,openCloseAutoCalltimer,autoCalltimer);
            m_controlview = new ControlDocmentView(ControlMenuItem);
            m_otherview = new OtherTypeDocmentView(OtherMenuItem);
            m_RPview = new RelayProtectForm(继保定值视图ToolStripMenuItem);//继保定值视图
            m_xmlcfgview = new XMLCfg(xML配置视图ToolStripMenuItem);//XML配置视图
 ...
 //               if (PublicDataClass._ProtocoltyFlag.NetProFlag == 1 || PublicDataClass._ProtocoltyFlag.ComProFlag == 2)
    ...
    * ***************************************************************************************************************************/
        ...
        * ******************************************************************************************/
        ...
        {
            MessageBox.Show("版本日期：2014-9-25-维护软件综合版本 ", "版本",MessageBoxButtons.OK, MessageBoxIcon.Information);
...
* ******************************************************************************************/
     ...
     * ******************************************************************************************/
        ...
        private void xml历史数据ToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        {
            if (autocall == null || autocall.IsDisposed)
                autocall = new AutoCall(autoCalltimer);
            autocall.Show();
        }

        private void autoCalltimer_Tick(object sender, EventArgs e)
        {
            PublicDataClass._NetTaskFlag.C_IC_NA_1 = true;
        ...
        {
            autoCalltimer.Enabled = true;
            openCloseAutoCalltimer.Enabled = false;
        }
