...
namespace FaTestSoft
{
    ...
    {
        public OtherTypeDocmentView(ToolStripMenuItem OtherMenuItem)
        {
            InitializeComponent();
            this.OtherMenuItem = OtherMenuItem;
        }
        ToolStripMenuItem OtherMenuItem;
        ...
        private void OtherTypeDocmentView_DockStateChanged(object sender, EventArgs e)
        {
