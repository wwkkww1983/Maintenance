...
namespace FaTestSoft
{
    ...
    {
        public HistoryDataDocmemtView(ToolStripMenuItem HisdataMenuItem)
        {
            InitializeComponent();
            this.HisdataMenuItem = HisdataMenuItem;
        }
        ToolStripMenuItem HisdataMenuItem;
        ...
        private void HistoryDataDocmemtView_DockStateChanged(object sender, EventArgs e)
        {
            if (this.Visible == false)
                HisdataMenuItem.Checked = false;
            else
