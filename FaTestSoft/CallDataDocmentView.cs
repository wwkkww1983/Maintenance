...
namespace FaTestSoft
{
    ...
    {
        public CallDataDocmentView(ToolStripMenuItem CallMenuItem)
        {
            InitializeComponent();
            this.CallMenuItem = CallMenuItem;
        }
        ToolStripMenuItem CallMenuItem;
        ...
        private void CallDataDocmentView_DockStateChanged(object sender, EventArgs e)
        {
            if (this.Visible == false)
                CallMenuItem.Checked = false;
            else
